...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function applyConfig(preset, text) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("input", {
            ...
            onKeyDown: (e) => {
              if (e.key === "Enter") doApply(preset, text);
            },
          }),
        ),
        React.createElement(
          ...
          React.createElement("button", { className: "dsg-btn", onClick: () => doApply(preset, text) }, "应用"),
